...
/**
 * 补丁文件,由eclipse svn plugin生成 补丁文件
 * 
 * @author zhong
 * @date 2019年7月12日 下午5:14:35
 */
public class FreePatchUtil {
 
	public static String patchFile="D:/patch.txt";//补丁文件,由eclipse svn plugin生成
	
	public static String projectPath="D:/workspace/yourprojectName";//项目文件夹路径
	
	public static String webContent="WebContent";//web应用文件夹名
	
	public static String classPath="D:/workspace/yourprojectName/build";//class存放路径
	
	public static String desPath="C:/Users/xuwen/Desktop/update_pkg";//补丁文件包存放路径
	
	public static String version="20190711";//补丁版本
